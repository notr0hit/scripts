...
def get_summary(filename="1.mp4", subtitles="1.srt", duration=60):
    ...
    Args:
        ...
        duration(int): duration of video (defaults to 60 seconds)
    Returns:
        True
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--duration', help="Duration of video in minutes")
    ...
    if not url:
        ...
        get_summary(args.video_file, args.subtitles_file, (int(args.duration) * 60))
